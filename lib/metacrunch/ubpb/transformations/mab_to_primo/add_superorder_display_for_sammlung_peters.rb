...
class Metacrunch::UBPB::Transformations::MabToPrimo::AddSuperorderDisplayForSammlungPeters < Metacrunch::Transformator::Transformation::Step
  ...
  def superorder_display
    ...
    if signature_search.include?("ZZVP1004")
      superorders << {
        ht_number: nil,
        label: "Sammlung Peters",
        volume_count: nil,
        label_additions: nil
      }
    end
